            ...
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 bg-[#2563EB] rounded-xl flex items-center justify-center">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path d="M2 9L9 2L16 9M4 7v8h4v-4h2v4h4V7" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <div>
                <div className="font-semibold text-[#F5F0E8] text-sm">FastNets</div>
                <div className="text-[10px] text-[#6B7280] tracking-wider uppercase">Àrea Privada</div>
              </div>
            </div>
          </div>
