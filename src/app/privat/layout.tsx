      ...
      <aside className="w-64 border-r border-[#2A2A2A] bg-[#0D0D0D] fixed top-16 bottom-0 left-0 z-30 flex flex-col">
        <div className="p-4 border-b border-[#2A2A2A]">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 bg-[#2563EB]/20 rounded-lg flex items-center justify-center">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <rect x="2" y="2" width="4" height="4" rx="0.5" fill="#2563EB"/>
                <rect x="8" y="2" width="4" height="4" rx="0.5" fill="#2563EB" opacity="0.5"/>
                <rect x="2" y="8" width="4" height="4" rx="0.5" fill="#2563EB" opacity="0.5"/>
                <rect x="8" y="8" width="4" height="4" rx="0.5" fill="#2563EB" opacity="0.3"/>
              </svg>
            </div>
            <div>
